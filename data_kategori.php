      ...
      <div class="col-12">
        <table class="table table-bordered">
          ...
          if (isset($_POST['pencarian'])) {
            ...
            $sql = "SELECT * from kategori where nama_kategori like '%$keybord%' order by nama_kategori ASC limit $halaman,$batas";
          }else {
            // query menampilkan data biasa
          $sql ="SELECT * from kategori order by nama_kategori ASC limit $halaman,$batas";
        }
        ...
        while ($row= mysqli_fetch_array($buku)) {
          ...
          <tr>
            ...
            <td><a  class="btn btn-success btn-sm" href="edit_kategori.php?id=<?php echo $row['id_kategori']; ?>">edit</a>
               <a onclick="return konfirmasi()" class="btn btn-danger btn-sm" href="del_kategori.php?id=<?php echo $row['id_kategori']; ?>">delete</a> </td>
          </tr>
        ...
        <a href="input_kategori.php" class="btn btn-danger btn-sm">Input Data kategori</a>
